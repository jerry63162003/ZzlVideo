//
//  MMHomeListViewController.swift
//  ZzlVideo
//
...
class MMHomeListViewController: UIViewController, JXSegmentedListContainerViewListDelegate, UITableViewDelegate, UITableViewDataSource {
